...
namespace ElementiumBrowser.Forms
{
    public partial class TabForm : Form
    {
        ...
        private void güncellemeleriDenetleToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!webClient.DownloadString("https://rentry.co/i7sv9/raw").Contains("3.2"))
                {
        ...
        {
            Process.Start("Snowrain.exe");

        }

        private void rtextbox_urlbox_TextChanged(object sender, EventArgs e)
        {
