...
class Player():
    ...
    def __init__(self, desired_scale_x, desired_scale_y, Width, Height):
        ...
        self.player_sprite.image = pygame.image.load(
            "Assetler/Textureler/Snowball.png").convert_alpha()
...
class Enemy(Entity):
    def __init__(self):
        ...
        self.initialiser((102, 107, 102), "Assetler/Sesler/RockHit.wav")
...
class Snowball(Entity):
    def __init__(self):
        ...
        self.position.x = random.randrange(0, 720)
        self.position.y = 0
        self.initialiser((255, 255, 255), "Assetler/Sesler/SnowballHit.wav")
        self.tag = "snowball"
...
class Spawner():
    ...
    def __init__(self, screen):
        self.screen = screen
        self.sound = mixer.Sound("Assetler/Sesler/SnowballPowerup.wav")
...
class Main():
    ...
    def setup_pygame(self, title, width, height):
        ...
        favicon = pygame.image.load("Assetler/Textureler/Favicon.png").convert_alpha()
    ...
    def update_score(self, screen, text):
        ...
        score += self.dt / 100
        score_int = int(score)
        score_text = text.render("SKOR: " + str(score_int),True,(0,0,0))
    ...
    def game(self, screen, font, WIDTH, HEIGHT):
        ...
        foreground.image = pygame.image.load(
            "Assetler/Textureler/Foreground.png").convert_alpha()
    ...
    def menu(self, screen, font, WIDTH, HEIGHT):
        ...
        sound = pygame.mixer.Sound("Assetler/Sesler/Start.wav")
        play_text = font.render("OYNA", True, (255,255,255))
        play_text_y_offset = 0

        score_text = font.render("EN YÜKSEK REKOR: " + str(int(max_score)), True, (255,255,255))

        tutorial_text = font.render("Eriyorsun!", True, (255,255,255))
        tutorial_text_2 = font.render("Kar tapunu hareket ettir ve göktaşlarından kaç!", True, (255,255,255))
    ...
    def __init__(self):
        ...
        while game_state != 2:
            ...
            screen = self.setup_pygame("Snowrain", WIDTH, HEIGHT)
            font = pygame.font.Font("Assetler/Fontlar/Inter.ttf", 32)
            ...
            sound = pygame.mixer.Sound("Assetler/Sesler/Die.wav")
            sound.play()
            self.reset_state()
            score = 0
            score_int = 0
